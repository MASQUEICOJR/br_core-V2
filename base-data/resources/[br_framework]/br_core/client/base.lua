...
function tBR.getNearestPlayer(radius)
	local p = nil
	local players = tBR.getNearestPlayers(radius)
...
function tBR.playSound(dict,name)
...
AddEventHandler("playerSpawned",function()
	TriggerServerEvent("BRcli:playerSpawned")
end)
