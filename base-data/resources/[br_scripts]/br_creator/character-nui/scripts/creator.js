...
const app = new Vue({
  ...
  methods: {
    ...
    changeAppearance: function () {
      ...
      $.post(
        "https://br_creator/UpdateSkinOptions",
        JSON.stringify(arr1)
      );
      ...
      $.post(
        "https://br_creator/UpdateFaceOptions",
        JSON.stringify(arr2)
      );
      ...
      $.post(
        "https://br_creator/UpdateHeadOptions",
        JSON.stringify(arr3)
      );
    },
    ...
    changeCamRotation: function () {
      $.post(
        "https://br_creator/cChangeHeading",
      ...
      $.post("https://br_creator/cDoneSave");
    },
  },
});
