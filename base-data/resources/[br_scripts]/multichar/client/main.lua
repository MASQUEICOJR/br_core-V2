...
CreateThread(function()
    ...
    TriggerServerEvent('br_core:player:ready', false)
...
local function PosSpawn()
    ...
    TriggerServerEvent('br_core:player:ready', true)
...
local function CreateNewPlayerScreenRegister()
    ...
    exports.sw_appearance:startPlayerCustomization(function(appearance)
        DoScreenFadeOut(100)
        Wait(100)
        TriggerServerEvent('br_core:server:updatePlayerAppearance', charId, appearance)
        Wait(0)
        ClearFocus()
        PreSpawn()
        Wait(0)
